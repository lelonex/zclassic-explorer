defmodule ZclassicExplorerWeb.Router do
  use ZclassicExplorerWeb, :router
  ...
  pipeline :browser do
    ...
    plug :put_root_layout, {ZclassicExplorerWeb.LayoutView, :root}
  end
  ...
  # scope "/api", ZclassicExplorerWeb do
  #   pipe_through :api
  # end
  ...
  if Mix.env() in [:dev, :test] do
    ...
    scope "/" do
      ...
      live_dashboard "/dashboard",
        metrics: ZclassicExplorerWeb.Telemetry,
